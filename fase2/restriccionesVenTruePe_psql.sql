...
ALTER TABLE TELEFONO_PRO
	ADD CONSTRAINT PK_TELEFONO_PRO PRIMARY KEY (RIF_P, TELEFONO);
ALTER TABLE TELEFONO_PRO
...
ALTER TABLE SE_PAGA
	ADD CONSTRAINT PK_SE_PAGA PRIMARY KEY (SERIAL_F);
ALTER TABLE SE_PAGA
	ADD CONSTRAINT FK_SE_PAGA FOREIGN KEY (SERIAL_F) REFERENCES LOTE;
ALTER TABLE SE_PAGA
...
ALTER TABLE ARTICULO_U
	ADD CONSTRAINT NO_NEGATIVO_ARTICULO_U_N_INV CHECK(NUM_INV>0);
ALTER TABLE ARTICULO_U
	ADD CONSTRAINT AÑO_ELAB_VALID_ARTICULO_U CHECK(AÑO_ELAB>1900);
ALTER TABLE ARTICULO_U
	ADD CONSTRAINT NO_NEGATIVO_ARTICULO_U_COD CHECK(COD_PRODUCTO>0);
...
ALTER TABLE DEPENDIENTE
	ADD	CONSTRAINT FK_DEPENDIENTE FOREIGN KEY (SEXO_P) REFERENCES PRIMA;
ALTER TABLE DEPENDIENTE
	ADD CONSTRAINT NO_NEGATIVO_DEPENDIENTE_NUM_DEP CHECK(NUM_DEP>0);
ALTER TABLE DEPENDIENTE
	ADD CONSTRAINT SEXO_VALID_DEPENDIENTE CHECK(SEXO IN ('F','M'));
ALTER TABLE DEPENDIENTE
	ADD CONSTRAINT SEXO_P_VALID_DEPENDIENTE CHECK(SEXO_P IN ('F','M'));
ALTER TABLE DEPENDIENTE
...
ALTER TABLE TRUEQUE
	ADD CONSTRAINT CLAVE_CONF_VALID_TRUEQUE CHECK(NUM_TARJETA>0);


ALTER TABLE CAMBIO 
	ADD CONSTRAINT PK_CAMBIO PRIMARY KEY (NUM_INV_C, SERIAL_TRUEQUE);
ALTER TABLE CAMBIO
	ADD CONSTRAINT FK_CAMBIO_ARTICULO_U FOREIGN KEY (NUM_INV_C) REFERENCES TRUEQUE;
ALTER TABLE CAMBIO
	ADD CONSTRAINT FK_CAMBIO_TRUEQUE FOREIGN KEY (SERIAL_TRUEQUE) REFERENCES TRUEQUE;
ALTER TABLE CAMBIO
	ADD CONSTRAINT NUM_INV_C_VALID_CAMBIO CHECK(NUM_INV_C>0);
ALTER TABLE CAMBIO
	ADD CONSTRAINT SERIAL_T_VALID_CAMBIO CHECK(SERIAL_TRUEQUE>0);
ALTER TABLE CAMBIO
...
ALTER TABLE REALIZA_TRUEQUE
	ADD CONSTRAINT PK_REALIZA_TRUEQUE PRIMARY KEY (SERIAL_R,CEDULA_CLIENTE,CEDULA_VENDEDOR);
ALTER TABLE REALIZA_TRUEQUE
	ADD CONSTRAINT FK_REALIZA_TRUEQUE_TRUEQUE FOREIGN KEY (SERIAL_R) REFERENCES TRUEQUE;
ALTER TABLE REALIZA_TRUEQUE
